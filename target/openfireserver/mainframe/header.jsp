	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%"
		...
		<TR height=56>
			<!-- <TD width=260><IMG height=56 src="../images/header_left.jpg"
				width=260></TD> -->
			<TD style="FONT-WEIGHT: bold; COLOR: #fff; PADDING-TOP: 20px" width=260><font size="5px">VideoLive后台管理系统</font> &nbsp;&nbsp; 
			</TD>	
			<TD style="FONT-WEIGHT: bold; COLOR: #fff; PADDING-TOP: 20px"
				align=middle>当前用户：<%=strName_session.getName() %> &nbsp;&nbsp; <a style="COLOR: #fff" 
